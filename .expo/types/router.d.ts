...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(home)` | `/(tabs)` | `/..\components\InboxCard` | `/_sitemap` | `/attendance` | `/auditlogs` | `/bookmark` | `/create` | `/home` | `/master` | `/profile` | `/reports` | `/scheduler` | `/sign-in` | `/sign-up` | `/visitreport`;
