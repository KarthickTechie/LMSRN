  ...
  return (
    <SafeAreaView className="bg-primary h-full">
      <FlatList
            ...
            <View className="my-6 px-4">
              <View className="flex-row mb-6 justify-between items-start">
                <View>
                  ...
                  <Text className="font-pregular text-2xl text-bold text-white">
                    LMS
                  </Text>
                </View>
              ...
              <Text className="text-gray-100 text-lg mb-3 my-3 text-pregular">
                Recent leads
              </Text>
        ...
        refreshControl={
          <RefreshControl tintColor="#FF9C01" refreshing={refreshing} />
        }
      />
    </SafeAreaView>
  );
